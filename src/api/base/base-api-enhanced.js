 ...
 * 
 * Enhanced version of BaseAPI with additional enterprise features.
 * Extends BaseAPI with AI integration, standardized responses, and advanced utilities.
 * 
 * Additional Features:
 * - MCP resource and prompt management
 * - Standardized response handling (APIResponseUtils)
 * - Service initialization utilities (with retry support)
 * - LLM service integration (OpenAI, Mock, custom providers)
 * - Logging utilities
 * - Graceful initialization (continues on partial failures)
 * 
 * Initialization:
 * - Automatic async initialization on first request
 * - Retry support for failed initializations
 * - Status tracking (pending, success, failed)
 * - Error reporting and recovery
 * 
 * LLM Integration:
 * - Multiple provider support (OpenAI, Mock)
 * - Streaming response support
 * - Service abstraction for easy provider switching
 * 
 * MCP Integration:
 * - Automatic resource loading from mcp/resources/
 * - Prompt management from mcp/prompts/
 * - Template parameter support ({{param}} syntax)
 * 
 * @class BaseAPIEnhanced
 * @extends BaseAPI
 * @example
 ...
 *     this.responseUtils.sendSuccessResponse(res, { data: 'Hello' });
 *   }
 * }
...
const APIResponseUtils = require('../utils/api-response-utils');
const Logger = require('../../utils/logger');
const MCPResourceLoader = require('../../utils/loaders/resource-loader');
const { createLLMService } = require('../../utils/llm/llm-service');
