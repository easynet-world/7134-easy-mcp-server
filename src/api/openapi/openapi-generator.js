 ...
 * Extracts schema information from JSDoc annotations and class properties
 * to create comprehensive API documentation.
 * 
 * Features:
 * - Automatic OpenAPI 3.0 specification generation
 * - JSDoc annotation parsing (@description, @param, @query, @body, @response)
 * - Schema extraction from class properties
 * - Component schema reuse
 * - Tag generation for endpoint grouping
