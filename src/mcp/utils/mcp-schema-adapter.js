 ...
 * MCP Schema Adapter
 * 
 * Translates tool parameters between different formats for bridge tool compatibility.
 * Currently handles Chrome DevTools MCP format adaptations.
 * 
 * Features:
 * - Parameter name mapping (n8n format → Chrome DevTools format)
 * - Tool-specific parameter adaptations
 * - Format normalization for bridge tools
 * 
 * Note: This adapter is primarily for Chrome DevTools MCP integration.
 * Most bridge tools use standard JSON-RPC 2.0 format and don't need adaptation.
 * 
