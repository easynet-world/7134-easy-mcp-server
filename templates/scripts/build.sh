...
echo ""
echo "   3️⃣  Global installation (recommended for CLI usage):"
echo "      npm install -g ./$PACK_FILENAME"
echo "      # After installation, you can run '$PACKAGE_NAME' from any directory"
echo "      # The command will read .env from the current working directory"
echo "      # Supports both HTTP/Streamable and STDIO MCP modes"
echo ""
