...
## **Generated by `easy-mcp-server init`**
```
my-api-project/
├── package.json          # Project configuration and dependencies
├── .env                  # Environment variables (PORT, CORS, etc.)
├── .gitignore           # Git ignore file for Node.js
├── index.js             # Main entry point (exports API classes)
├── api/                 # API endpoints directory
│   └── example/
│       ├── get.js       # GET /example endpoint
│       └── post.js      # POST /example endpoint
